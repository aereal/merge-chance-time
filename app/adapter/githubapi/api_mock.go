...
// Source: github.com/aereal/merge-chance-time/app/adapter/githubapi (interfaces: Client,RepositoriesService,PullRequestService,AppsService,UsersService)
...
func (m *MockClient) Apps() AppsService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Apps")
	ret0, _ := ret[0].(AppsService)
	return ret0
}

// Apps indicates an expected call of Apps
func (mr *MockClientMockRecorder) Apps() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Apps", reflect.TypeOf((*MockClient)(nil).Apps))
}

// PullRequests mocks base method
func (m *MockClient) PullRequests() PullRequestService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PullRequests")
	ret0, _ := ret[0].(PullRequestService)
	return ret0
}
...
func (m *MockClient) Repositories() RepositoriesService {
	...
	ret0, _ := ret[0].(RepositoriesService)
	return ret0
}
